export default function ConfirmDialog({
    ...
    cancelButtonClass = "bg-slate-800 hover:bg-slate-700"
}) {
            ...
            >
                ...
                <div className="flex gap-3 justify-end">
                    <button
                        onClick={onCancel}
                        disabled={isLoading}
                        className={`px-4 py-2 rounded-md font-medium text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${cancelButtonClass}`}
                    >
                        {cancelText}
                    </button>
